    ...
    opts = {
      mappings = {
        ...
        v = {
          ...
          ["<Leader>sC"] = { ":!cowsay", desc = "Cow It" },
          ["<Leader>sF"] = { ":!figlet -c -t", desc = "Figl It" },
          ...
          ["<Leader>sRb"] = { ":g/^$/d", desc = "Blank Lines Delete" },
        ...
        n = {
          ...
          -- change list also g, and g;
          ["<A-,>"] = { ":cprev<CR>", desc = "Prev Quickfix Record" },
          ["<A-.>"] = { ":cnext<CR>", desc = "Next Quickfix Record" },
          -- Quickfix
          ["<A-I>"] = { "g,<CR>", desc = "Prev Changelist Record" },
          ["<A-O>"] = { "g;<CR>", desc = "Next Changelist Record" },
