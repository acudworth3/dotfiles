# FIXME refactor this by section
...
## alias git=git.exe
alias gsavegame='git add --all && git commit -m "Auto-commit on $(date)" && git push'
alias lg='lazygit'
...
## Yazi setup https://yazi-rs.github.io/docs/quick-start
function y() {
